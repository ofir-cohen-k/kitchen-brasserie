        ...
        <div className="container">
          ...
          <div className="home-faq-grid reveal">
            {[
              ...
              { q: 'האם אפשר לעשות בראנץ ב-Kitchen Brasserie?', a: 'בהחלט! אנחנו מגישים ארוחות בוקר ובראנץ עשירים בימים ראשון עד שישי עד השעה 13:00. התפריט כולל מנות חלביות, ביצים בהכנות שונות, מאפים טריים ועוד — הכל כשר בד״ץ בית יוסף.' },
